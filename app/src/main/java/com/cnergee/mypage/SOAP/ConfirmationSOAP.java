...
public class ConfirmationSOAP {
	...
	public void setConfirmationDetails(SoapObject response,
		...
		if (response.getPropertyAsString("CustomerName").equals("anyType{}"))
		{
			confirmationdetails.setCustomerName("");
		}else {
		...
		{
			confirmationdetails.setMemberLoginId("");
		}else {

			confirmationdetails.setMemberLoginId(response.getPropertyAsString(
					"MemberLoginID").toString());
		}
		if (response.getPropertyAsString("InstallationAddress")
				.toString().equals("anyType{}"))
		{
			confirmationdetails.setInstallationAddress("");
		}
		else {
		...
		if (response.getPropertyAsString("MobileNoprimary")
				.toString().equals("anyType{}"))
		{
			confirmationdetails.setMobileNoprimary("");
		}else {

			confirmationdetails.setMobileNoprimary(response.getPropertyAsString("MobileNoprimary")
					.toString());
		}
		if (response.getPropertyAsString("MemberId").toString().equals("anyType{}"))
		{
			confirmationdetails.setMemberId("");
		}
		else {
		...
		if (response.getPropertyAsString("showLogo").toString().equals("anyType{}"))
		{
			confirmationdetails.setShowLogo("");
		}
		else {

			confirmationdetails.setShowLogo(response.getPropertyAsString("showLogo").toString());
		}
		if (response.getPropertyAsString("CustomerCareNumber").toString().equals("anyType{}"))
		{
			confirmationdetails.setCustomerCareNumber("");
