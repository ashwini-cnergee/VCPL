	...
	private void showNotification(String Message) {
		...
		if (Build.VERSION.SDK_INT > 15) {
			...
			Notification notification = new Notification.Builder(GcmMessageHandler.this)
					.setContentTitle("VCPL  Notification").setContentText(Message)
			...
			Notification notification = new Notification(R.drawable.ic_launcher,
					"VCPL  Notification", System.currentTimeMillis());
			notification.defaults |= Notification.DEFAULT_SOUND;
			notification.vibrate = new long[] { 0, 100, 200, 300 };
			// Clear the status notification when the user selects it
			notification.flags |= Notification.FLAG_AUTO_CANCEL;

			//notification.setLatestEventInfo(GcmMessageHandler.this, "VCPL  Notification ", Message,
			//		contentIntent);
			notificationManager.notify(notifID, notification);
			...
			//	Iterator iter = notificationList.iterator();
				...
				//while(iter.hasNext()){
					...
					Notification notification = new Notification.Builder(this)
				     .setContentTitle("VCPL  Notification")
				...
				for(int i=0;i<notificationList.size();i++){
					...
					if(NotifyObj.getIsNotify()!=null){
						...
						Notification notification = new Notification(R.drawable.ic_launcher, "VCPL  Notification",System.currentTimeMillis());
						notification.defaults |= Notification.DEFAULT_SOUND;
						notification.vibrate = new long[] { 0, 100, 200, 300 };
						  //Clear the status notification when the user selects it
						notification.flags|=Notification.FLAG_AUTO_CANCEL;  
					
					//	notification.setLatestEventInfo(this, "VCPL  Notification ", NotifyObj.getNotificationMessage(), contentIntent);
						notificationManager.notify(Integer.parseInt(NotifyObj.getNotifyId()), notification);
